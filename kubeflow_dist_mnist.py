...
MODEL_SAVE_PATH = "/wxwang/model"
MODEL_NAME = "model.ckpt"



flags = tf.app.flags
flags.DEFINE_string("data_dir", "/wxwang/MNIST_data",
...
flags.DEFINE_integer("replicas_to_aggregate", None,
                     ...
                     "num_workers)")
flags.DEFINE_integer("hidden_units", 10,
...
def main(unused_argv):
  ...
  with tf.device(
    ...
    #writer = tf.summary.FileWriter("/wxwang", tf.get_default_graph())
    #writer.close
